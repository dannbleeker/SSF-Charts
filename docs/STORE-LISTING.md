...
- ⛔ **1–5 screenshots** 1366×768 of the pane + an inserted chart — **still
  missing, but the reason below was half wrong and was corrected 2026-09-13.**
  ...
  **What was wrong: "a screenshot showing an inserted chart is not [capturable]".
  ...
  So the pane is capturable and the slide-with-chart is capturable. **What is
  not available headlessly is one AUTHENTIC frame containing both.** Three ways
  to close it, and the choice is the owner's:
